  ...
  return (
    <s.Screen>
      <s.Container
        ...
        image={CONFIG.SHOW_BACKGROUND ? "/config/images/background.jpeg" : null}
      >
        <StyledLogo alt={"logo"} src={"/config/images/logo.png"} />
  
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImg alt={"example"} src={"/config/images/vistroBrand.png"} />
          </s.Container>
          <s.SpacerLarge />
          <s.Container
            flex={2}
                ...
                blockchain.smartContract === null ? (
                  ...
                  <>
                    ...
                    <s.Container ai={"center"} jc={"center"} fd={"row"}>
                      ...
                      >
                        {claimingNft ? "Creating a Vistro" : "BUY"}
                      </StyledButton>
                    </s.Container>
                  </>
                )}
          ...
          <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImg
              alt={"example"}
              src={"/config/images/vistroBrand.png"}
        ...
        <s.Container jc={"center"} ai={"center"} style={{ width: "70%" }}>
          ...
          >
            ...
            Once you make a purchase, you cannot undo this action.
